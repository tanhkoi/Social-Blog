...
const About = () => {
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-[#0E1217] p-4">
      <div className="bg-[#0E1217] rounded-lg shadow-lg p-8 max-w-3xl text-left ">
