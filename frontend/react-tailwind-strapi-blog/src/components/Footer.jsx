  ...
  return (
    <div className="w-full bg-[#02044A] text-gray-300 py-8 px-2">
      <div className="max-w-[1240px] mx-auto grid grid-cols-2 md:grid-cols-6 border-b-2 border-gray-600 py-8">
        <div>
          <h6 className="font-bold uppercase py-2">CWTS</h6>
        </div>
        <div>
          ...
          <ol>
            ...
            <p className="py-1">CWTS@gmail.com</p>
            <p className="py-1">+88015-88888-9999</p>
          </ol>
        </div>
        <div>
          <h6 className="font-bold uppercase py-2">Account</h6>
          <ol>
            <p className="py-1">My Account</p>
            <p className="py-1">Login / Signup</p>
          </ol>
        </div>
        <div>
          <h6 className="font-bold uppercase py-2">Quick Link</h6>
          <ol>
            <p className="py-1">Privacy Popcy</p>
